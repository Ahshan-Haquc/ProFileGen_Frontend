...
//                                 className={`relative flex flex-col p-8 rounded-[2.5rem] hover:scale-103 transition-all duration-500 border ${tier.popular
...
//                                 <Button
//                                     className={`w-full py-7 rounded-2xl font-bold text-lg transition-all active:scale-95 ${tier.popular
